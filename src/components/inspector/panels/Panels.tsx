...
const Panels: React.FC<{ component: any; isRoot: boolean }> = ({
  ...
  return (
    <>
      ...
      {type === 'CategoryShowcase' && <CategoryPanel />}
      {type === 'PageHeader' && <PageHeaderPanel />}
      {type === 'CallToAction' && <CallToActionPanel />}
      {type === 'StorePopups' && <StorePopupsPanel />}
      {type === 'Banner' && <BannerPanel />}
