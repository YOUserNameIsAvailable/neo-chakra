...
ReactDOM.render(
  ${isCurrencyCoverter ? '<QueryClientProvider client={queryClient}>' : ''}
    <App />
  ${isCurrencyCoverter ? ' </QueryClientProvider>' : ''}
...
`,
  ...
  "dependencies": {
    ...
    "react-scripts": "^5.0.1",
    "react-icons": "^4.11.0",
    ${isCurrencyCoverter ? '"@tanstack/react-query": "^4.36.1",' : ''}
    "axios": "^1.3.3"
  },
  "devDependencies": {
    "typescript": "3.3.3",
